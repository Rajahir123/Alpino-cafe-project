      ...
      <nav
        className={`fixed top-0 w-full z-50 transition-all duration-500 ease-in-out ${
          scrolled
            ...
            : "bg-transparent py-4 md:py-12 border-transparent"
        } px-4 md:px-12 flex justify-between items-center`}
      >
        <Link
          to="/"
          className="hover:opacity-90 transition-all duration-500 flex-shrink-0 flex items-center relative h-10 md:h-12"
        >
          {!scrolled ? (
            <motion.div
        ...
        <div className="flex gap-2 md:gap-10 items-center">
          <Link
            to="/menu"
            className="hidden lg:block text-xs font-black hover:text-red-500 transition-colors uppercase tracking-[0.3em]"
          >
            Menu
          </Link>
          <a
          ...
          <Link
            to="/login"
            className={`hidden md:block bg-transparent hover:bg-white/10 text-white rounded-xl text-[10px] md:text-sm font-black uppercase tracking-[0.2em] transition-all border border-white/20 hover:border-white/50 ${
          ...
          <Link
            to="/plans"
            className={`bg-red-600 hover:bg-red-700 text-white rounded-xl text-[8px] md:text-sm font-black uppercase tracking-[0.2em] transition-all shadow-[0_4px_25px_rgba(220,38,38,0.4)] hover:scale-105 active:scale-95 ${
              scrolled
                ? "px-3 md:px-8 py-2 md:py-3"
                : "px-4 md:px-10 py-2.5 md:py-4"
            }`}
          >
            Join Now
          </Link>
      ...
      <section className="relative min-h-[85vh] md:h-screen flex items-center justify-center pt-28 md:pt-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
              ...
              {[
                ...
                <div key={i} className="flex flex-col items-center group">
                  <div className="flex items-center gap-2 bg-neutral-900 border border-white/5 px-3 md:px-5 py-2 md:py-3 rounded-lg md:rounded-xl group-hover:border-red-600/50 transition-all duration-300">
                    ...
                    <span className="text-[10px] md:text-sm font-black text-red-600 italic tracking-tighter group-hover:animate-pulse">
                      {item.status}
                    </span>
                  </div>
          ...
          >
            <Link
              to="/plans"
              className="bg-red-600 hover:bg-red-700 text-white px-6 md:px-10 py-3.5 md:py-4 rounded-xl text-xs md:text-lg font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 group shadow-[0_4px_20px_rgba(220,38,38,0.4)]"
            >
              Start Your Plan{" "}
              <ChevronRight
                size={16}
            ...
            <Link
              to="/menu"
              className="border-2 border-white/20 hover:border-red-600 hover:bg-red-600/10 px-6 md:px-10 py-3 md:py-4 rounded-xl text-xs md:text-lg font-black uppercase tracking-widest transition-all"
            >
              View Menu
            </Link>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="absolute -bottom-6 -right-6 bg-red-600 text-white p-8 rounded-2xl shadow-[0_10px_40px_rgba(220,38,38,0.4)] transform rotate-3 z-30">
                ...
                <div className="uppercase font-bold tracking-widest text-sm text-white/80">
                  Nutritious
                </div>
              </div>
            </motion.div>
            ...
            {["All", "Bowl", "Smoothies", "Shake", "Wrap"]
              ...
              .map((cat) => (
                ...
                >
                  ...
                  <div
                    className={`absolute inset-0 border-2 rounded-xl md:rounded-2xl transition-colors duration-300 ${
                      selectedCategory === cat
                        ? "border-red-600"
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            <div
                              className={`relative aspect-square mb-6 rounded-3xl bg-neutral-900 border transition-all duration-500 shadow-2xl flex items-center justify-center overflow-hidden ${tappedItemId === item.id ? "border-red-600/30" : "border-white/5 group-hover:border-red-600/30"}`}
                            >
                              ...
                              {/* Floating Price */}
                              <div
                                className={`absolute bottom-6 right-6 bg-red-600 text-white px-4 py-2 rounded-xl font-black text-xl shadow-xl transform transition-transform z-40 ${tappedItemId === item.id ? "rotate-0" : "rotate-3 group-hover:rotate-0"}`}
                              >
                                ₹{item.price}
                              </div>
                              ...
                              <div className="absolute top-6 left-6 flex flex-col gap-2 z-40">
                                <div className="bg-black/80 backdrop-blur-md px-3 py-1 rounded-lg border border-white/10">
                                  <span className="text-[10px] font-black uppercase text-red-600 tracking-tighter">
                                    Protein
                                  </span>
                            ...
                            <div className="px-2">
                              ...
                              <h3
                                className={`text-2xl font-black italic uppercase italic tracking-tighter mb-3 transition-colors ${tappedItemId === item.id ? "text-red-500" : "group-hover:text-red-500"}`}
                              >
                                {item.name}
                              </h3>
                              ...
                              <div className="flex items-center justify-between">
                                <div className="flex gap-4">
                                  <div className="flex flex-col">
                                    <span className="text-[8px] font-bold uppercase text-white/30 tracking-widest text-[8px]">
                                      Energy
                                    </span>
                                ...
                                <Link
                                  to="/login"
                                  className={`p-3 rounded-xl transition-all border ${tappedItemId === item.id ? "bg-red-600 text-white border-red-600 translate-x-2" : "bg-white/5 hover:bg-red-600 hover:text-white border-white/5 hover:border-red-600 group-hover:translate-x-2"}`}
                                >
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex justify-center gap-4 text-sm font-bold uppercase tracking-widest mb-12">
              <span className="flex items-center gap-1 text-red-500">
                <Star size={14} fill="currentColor" /> Premium Ingredients
              </span>
              <span className="flex items-center gap-1 border-l border-white/10 pl-4">
                <Clock size={14} /> Flexible Delivery
              </span>
            </div>
          </div>
